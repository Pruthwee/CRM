...
class UserControllerTest {
    ...
    @Test
    void testShowAllUsers_returnsCorrectView() {
    ...
    @Test
    void testShowFormEditUser_returnsCorrectView() {
    ...
    @Test
    void testProcessRequestEditUser_noErrors_editsAndRedirects() {
    ...
    @Test
    void testProcessRequestEditUser_withDifferentId() {
        when(bindingResult.hasErrors()).thenReturn(true);
        String view = userController.processRequestEditUser(99L, user, bindingResult);
        assertEquals("redirect:/user/edit/99", view);
    }
}
