...
/**
 * PDF Controller with cloud-native S3 storage integration.
 * Replaces local file system writes with Amazon S3 for durable storage.
 */
@Controller
@Slf4j
public class PdfController {
    ...
    /**
     * Generates PDF and uploads to S3 instead of local file system.
     * 
